...
$(document).ready(function(){
  ...
  $('.site-slider').owlCarousel({
      ...
      items: 1,
      nav: true,
      navText:["<div class='nav-btn prev-slide'><i class='material-icons'>arrow_backward</i></div>",
          "<div class='nav-btn next-slide'><i class='material-icons'>arrow_forward</i></div>"],
